...
public class EnglishquizResult extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        TroVe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.start();
                Intent intent = new Intent(EnglishquizResult.this, Englishquiz.class);
        ...
        PlayAgain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.start();
                Intent intent1 = new Intent(EnglishquizResult.this, Playername.class);
